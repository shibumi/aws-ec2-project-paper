...
\begin{frame}
    ...
    \begin{itemize}
        \item Rechenzentren über die Welt verstreut
            \begin{itemize}
                \item USA
                \item Deutschland
                \item \dots
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Ausführen eines Betriebssystems in einem anderen
...
\begin{frame}
    ...
    \begin{itemize}
        \item PV
            \begin{itemize}
                \item steht für paravirtual
                \item hat einen speziellen Bootloader
                \item Virtualisierung nur durch Software
                \item \implies Kein Zugriff auf Hardware-Schnittstellen
            \end{itemize}
        \item HVM
            \begin{itemize}
                \item steht für hardware virtual machine
                \item performanter
                \item echte virtualisierung auf Hardware-Ebene
                \item \implies Zugriff auf Hardware-Schnittstellen
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Isolation
        \item Betriebssystem-Kernel Support benötigt
...
\begin{frame}
    ...
    \includegraphics[width=1.0\textwidth]{figures/traditional_firewall.pdf}
\end{frame}

\begin{frame}
    \frametitle{AWS Security Groups}
    \includegraphics[width=1.0\textwidth]{figures/aws_firewall.pdf}
\end{frame}
