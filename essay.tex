...
\begin{table}[h]
\centering
\caption{Beispiel für die Varianz der Instanzen anhand vom Typ
    T2\footcite{Incd}}
...
\begin{itemize}
    ...
    \item Brasilien
\end{itemize}
Diese Länder sind eingeteilt in folgende Regionen:
\begin{itemize}
    \item Nordamerika
...
abgedeckt. Zusätzlich zu diesen Regionen gibt es noch sogenannte
...
Städten innerhalb einer Region. Für die Region Nordamerika ist dies
beispielsweise \footcite{Ince}:
\begin{itemize}
    ...
    \item AWS GovCloud
\end{itemize}
AWS GovCloud ist eine Sonderzone und isoliert von allen anderen Zonen.
AWS GovCloud hosted Applikationen und Informationen der
US-Regierung.\footcite{Incf}
